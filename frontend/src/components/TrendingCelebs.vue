<template>
  <div class="flex flex-col lg:flex-row justify-center mt-[2.5rem] text-black dark:text-[#F5F5F5]">

    <div class="lg:w-[290px]">

      <h1 class="font-semibold text-2xl text-center">Actors in Theatres</h1>
          ...
          <div class="flex flex-col lg:flex-row mt-2">
            ...
            <div v-for="person in movie.people" class="flex flex-col justify-center items-center w-[15rem]">
              ...
              <router-link :to="'/person/' + 'Tim Allen'">
                ...
                class="rounded h-[10rem] w-[10rem] object-cover">
              </router-link>
